...
if __name__ == "__main__":
    ...
    params = [{"name": "a", "type": "int", "description": "Description of param a", "default": 1},
              {"name": "b", "type": "str", "description": "Description of param b", "default": "one"},]
    return_type = "str"
    ...
    for exception in exceptions:
        docstring += ' '* indentation_level + f':raises {exception["name"]}: {exception["description"]}\n'
    if len(exceptions) > 0:
        docstring += '\n'
    docstring += ' '* indentation_level + '"""'
